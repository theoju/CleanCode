//--------------------------------------------------------------------------
// <copyright file="IContactManager.cs" company="none ">
...
namespace DesignItRight.CleanCodeDemo.ContactManagement
{
    ...
    /// </summary>
    [ContractClass(typeof(ContactManagerContract))]
    ...
    /// </summary>
    [ContractClassFor(typeof(IContactManager))]
    internal abstract class ContactManagerContract : IContactManager
    {
        #region -------------------- Public Methods --------------------
